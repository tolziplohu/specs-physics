...
pub(crate) trait GeneralizedCross {
    ...
    type CrossVector;
    /// The matrix representation of this (non-standard) generalized cross
    /// product.
    type CrossMatrix;
    /// The transposed matrix representation of this (non-standard) generalized
    /// cross product.
    type CrossMatrixTr;
    ...
    /// Computes the matrix representation of this (non-standard) generalized
    /// cross product.
    fn gcross_matrix(&self) -> Self::CrossMatrix;

    /// Computes the transposed matrix representation of this (non-standard)
